...
#include "mex.h"
#include "matrix.h"
#include <stdint.h> // Use standard fixed-width integer types
...
/* Define correct type using standard fixed-width integer types from <stdint.h> */
typedef int64_t int64; // 64-bit integer
typedef int32_t int32; // 32-bit integer
typedef int16_t int16; // 16-bit integer
typedef int8_t  int08; // 8-bit integer

// /* Define correct type depending on platform /Users/gsecer/Documents/MATLAB/findfirst/findfirst_install.m
